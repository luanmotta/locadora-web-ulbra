...
<center>
	<form action="confirma_deletar.php" method="post">
		...
		<div style="display: flex; justify-content: center"><input style="margin-top: 10px" type="submit" value="Deletar Pedido"></div>
	</form>
</center>
